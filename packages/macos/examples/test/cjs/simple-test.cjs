/**
 * iohook-macos Simple CLI Example (Test - CommonJS)
 * 
 * 실행 방법:
 *   node packages/macos/examples/test/cjs/simple-test.cjs
 */

const iohook = require('@iohook/macos')

console.log('🚀 iohook-macos Simple CLI Example (Test - CommonJS)\n')
