/**
 * iohook-macos Simple CLI Example (Electron - ESM)
 * 
 * 실행 방법:
 *   node packages/macos/examples/electron/esm/simple-cli.mjs
 */

import iohook from '@iohook/macos'

console.log('🚀 iohook-macos Simple CLI Example (Electron - ESM)\n')
