/**
 * iohook-macos Simple CLI Example (Electron - CommonJS)
 * 
 * 실행 방법:
 *   node packages/macos/examples/electron/cjs/simple-cli.cjs
 */

const iohook = require('@iohook/macos')

console.log('🚀 iohook-macos Simple CLI Example (Electron - CommonJS)\n')
